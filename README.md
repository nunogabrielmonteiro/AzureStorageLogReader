...
It is a GUI Windows application (.Net 4.8) that allows to read and export the Azure Storage Log files.  <a href="https://nunomo.github.io/AzureStorageLogReader/">(Check the Website)</a>
